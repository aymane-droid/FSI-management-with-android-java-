...
public class CustomAdapter_Etu extends BaseAdapter {
    ...
    public CustomAdapter_Etu(Activity context, int listItemLayoutResource,
    ...
    public long getItemId(int position) {
        Etudiant language = (Etudiant) this.getItem(position);
        //int id = language.getCIN();
        //return language.getCIN();
        return position; //(Return position if you need).
    }

    public String getCNE(int position){
        Etudiant language = (Etudiant) getItem(position);
        ...
        textViewItemPercent.setText(language.getCNE());

        return language.getCNE();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView textViewItemPercent = (TextView) rowView.findViewById(textViewItemPercentId);
        textViewItemPercent.setText("CNE : "+language.getCNE());
